...
export const textOnSurfacePairs: readonly TextOnSurfacePair[] = freezeDeep([
  ...
  { name: 'textPrimary/brand', fg: color.textPrimary, bg: color.brand, usage: 'body' },
  { name: 'textPrimary/brandDeep', fg: color.textPrimary, bg: color.brandDeep, usage: 'body' },
  { name: 'onDanger/dangerSurface', fg: color.onDanger, bg: color.dangerSurface, usage: 'body' },
  {
    name: 'onDanger/dangerSurfacePressed',
    fg: color.onDanger,
    bg: color.dangerSurfacePressed,
    usage: 'body',
  },
