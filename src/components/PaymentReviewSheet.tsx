...
const styles = StyleSheet.create({
  ...
  label: { color: color.textSecondary, fontSize: typeRole.meta.fontSize, fontWeight: '600', marginTop: space.sm },
  ...
  warningBox: { flexDirection: 'row', gap: space.sm, alignItems: 'flex-start', marginTop: space.sm },
  ...
  warning: { flex: 1, color: color.warningStrong, fontSize: typeRole.caption.fontSize, lineHeight: 18 },
  ...
  cancelText: { color: color.textSecondary, fontSize: typeRole.callout.fontSize, fontWeight: '600' },
});
