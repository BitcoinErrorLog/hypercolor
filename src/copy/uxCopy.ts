...
export const COPY = {
  ...
  confirmThisIdentity: 'Confirm this identity',
  confirmThisIdentityBody: 'This is the pubky Pubky Ring authorized. Confirm to continue.',
  copyPubky: 'Copy pubky',
  installPubkyRing: 'Install Pubky Ring',
  pubkyRingPlayStoreUrl: 'https://play.google.com/store/apps/details?id=app.pubkyring',
  authorizationUrlLabel: 'Authorization URL',
  authorizationExpired: 'Authorization expired',
  authorizationExpiredBody: 'The authorization URL is only valid for five minutes.',
  enableExpiredBody: 'This authorization expired. Generate a new one.',
  welcomeExpiredBody: 'This authorization expired. Generate a new one.',
