...
Wait for testID `vrtSceneReady`, then screenshot. Maestro flows under `.maestro/vrt/generated/` are regenerated by `npm run vrt:catalog`. Capture names: `journey/screen/state/platform/device.png`.
